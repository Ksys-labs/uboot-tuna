...
{
#ifdef CONFIG_ANDROID_FORCE_KERNEL_ADDR
	return CONFIG_ANDROID_FORCE_KERNEL_ADDR;
#endif
	return hdr->kernel_addr;
}

static u32 android_img_get_initrd(struct andr_img_hdr *hdr)
{
#ifdef CONFIG_ANDROID_FORCE_INITRD_ADDR
	return CONFIG_ANDROID_FORCE_INITRD_ADDR;
#endif
